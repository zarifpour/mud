...
uint256 constant ID = uint256(keccak256("mudwar.prototype.LuckGem"));

function LuckGemPrototype(IUint256Component components) {
  ItemTypeComponent(getAddressById(components, ItemTypeComponentID)).set(ID, uint32(ItemTypes.LuckGem));
